...
for _col in ['tc_ms', 'tc_err_ms', 'tc_bound_min', 'tc_bound_max', 'C', 'C_err']:
    if _col not in OGSE_SIGNAL_COLS:
        insert_at = OGSE_SIGNAL_COLS.index('D0_m2_ms') if 'D0_m2_ms' in OGSE_SIGNAL_COLS else len(OGSE_SIGNAL_COLS)
        OGSE_SIGNAL_COLS.insert(insert_at, _col)
...
NOGSE_CONTRAST_COLS = [
    ...
    'g2_max_corr_mTm',
    'peak_g_max_mTm',
    'g1_search_max_raw_mTm',
    'g2_search_max_raw_mTm',
    'g1_search_max_corr_mTm',
    'g2_search_max_corr_mTm',
