...
MAKE_CONTRAST_WRAPPER="$SCRIPT_DIR/3.1-run_make_contrast_selected.sh"
...
export SIGNAL_G_TYPE="${SIGNAL_G_TYPE:-g}"
...
export SIGNAL_D0_INIT="${SIGNAL_D0_INIT:-0.0023}"
export PEAK_D0_FIX="${PEAK_D0_FIX:-2.3e-12}"
