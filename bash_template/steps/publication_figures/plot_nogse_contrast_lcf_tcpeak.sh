...
PLOT_SCRIPT="$REPO_ROOT/scripts/plotting/plot_publication_contrast_lcf_tcpeak.py"
...
BRAINS_EXCLUDE_TD_MS="${BRAINS_EXCLUDE_TD_MS:-76}"
...
PHANTOMS_DIRECTIONS="${PHANTOMS_DIRECTIONS:-3 1}"
PHANTOMS_EXCLUDE_TD_MS="${PHANTOMS_EXCLUDE_TD_MS:-75.1}"
PHANTOMS_D0="${PHANTOMS_D0:-2.3e-12}"

# Default phantoms aliases for this requested figure: 1=transversal, 3=longitudinal.
PHANTOMS_DIRECTION_ALIAS="${PHANTOMS_DIRECTION_ALIAS:-1=transversal 3=longitudinal}"
