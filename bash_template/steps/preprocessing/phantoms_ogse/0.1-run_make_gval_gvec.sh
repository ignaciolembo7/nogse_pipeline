...
usage() {
  echo "Usage:"
  echo "  bash nogse_pipeline/bash_template/phantoms_ogse/0.1-run_make_gval_gvec.sh [options]"
  echo
  echo "Options:"
  ...
  echo
  echo "Example:"
  echo "  bash nogse_pipeline/bash_template/phantoms_ogse/0.1-run_make_gval_gvec.sh"
  exit 1
}
