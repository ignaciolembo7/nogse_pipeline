...
usage() {
  echo "Usage:"
  echo "  bash nogse_pipeline/bash_template/phantoms_ogse/0.2-prep_phantom_b0.sh [options]"
  echo
  echo "Options:"
  ...
  echo
  echo "Examples:"
  echo "  bash nogse_pipeline/bash_template/phantoms_ogse/0.2-prep_phantom_b0.sh"
  echo
  echo "  bash nogse_pipeline/bash_template/phantoms_ogse/0.2-prep_phantom_b0.sh \\"
