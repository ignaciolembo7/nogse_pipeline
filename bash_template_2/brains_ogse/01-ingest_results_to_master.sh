...
Examples:
  bash 01-ingest_results_to_master.sh Data-signals/Results/20220622_BRAIN

  bash 01-ingest_results_to_master.sh \
    Data-signals/Results/20220622_BRAIN \
    Data-signals/Results/20220701_BRAIN
...
exec bash "$SCRIPT_DIR/../run_dataset.sh" brains ingest
