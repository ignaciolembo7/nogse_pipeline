...
def main() -> None:
    ...
    ap.add_argument("--brains-model", default="rest")
    ...
    ap.add_argument("--phantoms-model", default="rest")
    ...
    specs = [
        ContrastDatasetSpec(
            ...
            or (brains_fit_root / "tcpeak_resampled_data_vs_td/pseudohuber_fixed_macro/params_pseudohuber_mode=fixed_macro_y=tc_peak_resampled_data_ms_k=None.xlsx"),
            roi=args.brains_roi,
        ...
        ContrastDatasetSpec(
            ...
            or (phantoms_fit_root / "tcpeak_resampled_data_vs_td/pseudohuber_fixed_macro/params_pseudohuber_mode=fixed_macro_y=tc_peak_resampled_data_ms_k=None.xlsx"),
