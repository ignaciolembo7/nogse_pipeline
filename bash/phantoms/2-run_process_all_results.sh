...
RESULTS_ROOT="${1:-$PROJECT_ROOT/Data-signals/Results/20220610-PHANTOM3}"
PARAMS="${2:-$PROJECT_ROOT/Data-signals/sequence_parameters_phantoms.xlsx}"
OUT_DIR="${3:-$PROJECT_ROOT/analysis/phantoms/ogse_experiments/data}"
