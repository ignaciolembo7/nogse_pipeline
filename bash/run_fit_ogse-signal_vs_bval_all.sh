...
python nogse_pipeline/scripts/fit_ogse-signal_vs_bval.py   "analysis/ogse_experiments/data-rotated/20230619_BRAIN-3_ep2d_advdiff_AP_919D_OGSE_10bval_06dir_d55_Hz000_b2000_QC-ROUTINE_20230619152408_10_results.rot_tensor.long.parquet"   --out_root "analysis/ogse_experiments/fits/fit_monoexp_ogse-signal-rotated"   --directions long tra   --ycol value_norm   --g_type bvalue   --fix_M0 1.0   --rois Left-Lateral-Ventricle Right-Lateral-Ventricle Syringe --auto_fit_points --auto_fit_min_points 5 --auto_fit_tol 1
