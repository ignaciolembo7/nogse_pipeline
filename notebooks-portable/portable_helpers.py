"""Self-contained helper for nogse_pipeline/notebooks-portable/.

Copies (kept in sync by hand) of:
  - nogse_pipeline/src/models/model_fitting.py          (verbatim, full file)
  - nogse_pipeline/src/plotting/publication/tc_param_vars.py  (subset: _roi_color_map + its
    constants, DEFAULT_BRAIN_MARKERS)

Exists so that this notebooks-portable/ folder, together with a master parquet table, can be
zipped and run on another machine with only numpy/pandas/matplotlib/scipy installed — no
nogse_pipeline/src/ needed. If model_fitting.py or _roi_color_map change upstream, re-copy them
here.
"""
...
# ═══════════════════════════════════════════════════════════════════════════
# Signal / contrast models — verbatim copy of nogse_pipeline/src/models/model_fitting.py
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
# Plotting helpers — subset of nogse_pipeline/src/plotting/publication/tc_param_vars.py
# ═══════════════════════════════════════════════════════════════════════════
